...
$config['rest_auth'] = 'basic';    //changed by sachi for basic authentication
//$config['rest_auth'] = 'digest';    //changed by sachi for digest authentication
...
$config['auth_source'] = '';   //changed by sachi
...
|
*/
$config['rest_valid_logins'] = ['dov' => 'sis#123@'];
/*
|--------------------------------------------------------------------------
