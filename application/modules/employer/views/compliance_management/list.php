<div class="section-body mt-3">
    <div class="container-fluid card">
        <form method="post" action="<?php echo base_url('employer/compliance-management/list'); ?>" data-parsley-validate="" class="form-group mt-3 mb-2">
          <div class="row">
             <div class="col-md-4">
             ...
             <div class="col-md-2">
                 <div class="form-group">
                   <a href="<?php echo base_url('employer/compliance-management/list'); ?>" class="btn btn-sm btn-primary btn-block form-control">Clear Filter</a>
                </div>
             </div>
          </div>
         </form>
                                 ...
                                 foreach ($cal_list as $key => $cal_val) {
                                  ...
                                  ?>
                                    <tr>
                                       ...
                                       <td><?php echo(!empty($cal_val['emp_name']) ? $cal_val['emp_name'] : ''); ?></td>
                                       <td><?php echo(!empty($cal_val['dept_name']) ? $cal_val['dept_name'] : ''); ?></td>
                                       <td><?php echo(!empty($cal_val['basic_DA_sal']) ? $cal_val['basic_DA_sal'] : ''); ?></td>
                                       <td><?php echo(!empty($cal_val['HRA']) ? $cal_val['HRA'] : ''); ?></td>
                                       ...
                                       <td class="seven_sec"><a href="<?php echo base_url('employer/compliance-management/list/').encode($sal_id); ?>" class="btn btn-primary" >Show</a></td>
...
<?php
$currDate = date('Y-m-d');
$report_file_name = 'Pay-slist-report-'.$currDate;
?>
