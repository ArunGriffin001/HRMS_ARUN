   ...
   <div class="container-fluid">
      ...
      <div class="row clearfix">
         <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                  ...
                  <a href="<?php echo base_url('employer/hrms/users'); ?>" class="my_sort_cut text-muted">
         ...
         <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                  <div class="ribbon-box green"><?php echo(!empty($employer_holiday) ? $employer_holiday : '0'); ?></div>
                  <a href="<?php echo base_url('employer/hrms/holiday'); ?>" class="my_sort_cut text-muted">
                  <i class="icon-like"></i>
                  <span>Holidays</span>
                  </a>
               </div>
         ...
         <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                  <div class="ribbon-box orange"><?php echo(!empty($employer_event) ? $employer_event : '0'); ?></div>
                  <a href="<?php echo base_url('employer/hrms/events'); ?>" class="my_sort_cut text-muted">
         ...
         <!-- <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                   <div class="ribbon-box orange"><?php echo'0'; ?></div>
                  <a href="<?php echo base_url('employer/dashboard/payroll'); ?>" class="my_sort_cut text-muted">
         ...
         <!-- <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                  <div class="ribbon-box orange"><?php echo'0'; ?></div>
                  <a href="<?php echo base_url('employer/hrms/accounts'); ?>" class="my_sort_cut text-muted">
         ...
         <!-- <div class="col-6 col-md-4 col-xl-2">
            <div class="card">
               <div class="card-body ribbon">
                  <div class="ribbon-box orange"><?php echo'0'; ?></div>
                  <a href="<?php echo base_url('employer/dashboard/report'); ?>" class="my_sort_cut text-muted">
