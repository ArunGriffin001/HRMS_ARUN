   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action">
             <a href="<?php echo base_url('employer/emp-management/leave_type/add'); ?>" class="btn btn-primary float-right"><i class="fa fa-plus mr-2"></i>Add Leave Type</a>
            <a href="<?php echo base_url('employer/emp-management/leave_type/list'); ?>" class="btn btn-primary float-left"><i class="fa fa-plus mr-2"></i>Show Leave Type</a>
         </div>
      </div>
   </div>
</div>
                    ...
                    <table class="table table-striped table-vcenter table-hover mb-0" id="leave_type_list">
                      <thead>
                        <tr>
                          ...
                          <th><?php echo $this->lang->line('tb_total_leave'); ?></th>
