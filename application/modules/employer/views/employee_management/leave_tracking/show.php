<table class="table table-striped">
        ...
        <tr>
            <!-- <td>Status:</td>
            <td><?php echo (!empty($leave_tracking->status) ? $leave_tracking->status : ''); ?></td> -->
        ...
        <tr><td>Admin HR Status:</td>
            <td><?php echo (!empty($leave_tracking->employer_approved_status) ? $leave_tracking->employer_approved_status : ''); ?></td>
        </tr>    
