      ...
      <div class="tab-content mt-3">
         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                  <form method="post" action="<?php echo base_url('employer/emp-management/project/updateProject/').encode($record->project_id); ?>" data-parsley-validate="" enctype="multipart/form-data">
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="form-group">
                              <label>Name*</label>
                              <input type="text" name="project_name" value="<?php echo $record->project_name; ?>" class="form-control" placeholder="Project name" required="" data-parsley-required-message="Please enter project name">
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="technology_name" required="" data-parsley-required-message="Please select technology">
                              ...
                              if(!empty($tech_arr)){
                                ...
                                ?>
                                <option value="<?php echo $tech_val->tech_id; ?>" <?php echo ($record->technology_name == $tech_val->tech_id ? 'selected' : '') ; ?>><?php echo $tech_val->tech_name; ?></option>
                                <?php
                                }
                              }
                              ?>
