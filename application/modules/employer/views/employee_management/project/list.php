      ...
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action">
           <!--  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fe fe-plus mr-2"></i><?php echo $this->lang->line('btn_add_project'); ?></button> -->
            <a class="btn btn-primary" href="<?php echo base_url('employer/emp-management/project/add'); ?>"><i class="fe fe-plus mr-2"></i><?php echo $this->lang->line('btn_add_project'); ?> </a>
         </div>
      </div>
   </div>
</div>
