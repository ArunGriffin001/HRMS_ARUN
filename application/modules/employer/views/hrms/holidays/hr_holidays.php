<div class="header_btn">
  <div class="header-action">
      <a href="<?php echo base_url('employer/hrms/holiday/list'); ?>" class="btn btn-primary float-right"><i class="fa fa-plus mr-2"></i>Manage Holiday</a>
  </div>
</div>
 <?php $employerID = $employerID; ?>
   <form method="post" action="<?php echo base_url('employer/hrms/holiday'); ?>" data-parsley-validate="" class="form-group"> 
