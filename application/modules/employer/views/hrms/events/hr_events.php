<div class="header_btn">
   <div class="header-action">
       <!-- <a href="<?php echo base_url('employer/hrms/events/add'); ?>" class="btn btn-primary float-right"><i class="fa fa-plus mr-2"></i>Add Events</a> -->  <a href="<?php echo base_url('employer/hrms/events/list'); ?>" class="btn btn-primary float-right"><i class="fa fa-plus mr-2"></i>Manage Events</a> 
   </div>
</div>
