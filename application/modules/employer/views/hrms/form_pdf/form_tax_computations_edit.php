<div class="section-body mt-3">
   ...
   ?>
      <form method="post" action="<?php echo base_url('employer/form_tax_computations'); ?>" data-parsley-validate="" enctype="multipart/form-data">
               ...
               <div class="row clearfix">
                    <div class="col-md-12 col-sm-12">
                     <div class="form-group">
                      <lable class="mb-2">Update tax computations</lable>
                      <br>
