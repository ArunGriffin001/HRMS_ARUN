   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action">
            <a href="<?php echo base_url('employer/asset/assign_to_employee'); ?>" class="btn btn-primary">Assign Asset To Employee</a>
                           ...
                           <tr> 
                              ...
                              <td>
                                 ...
                                 if($asset_val->status == "Deactive"){
                                    $status = 'Active';
                                    $actionStatus ='<a class="btn btn-danger waves-effect" style="width: 100% !important;" href="javascript:void(0);" onclick="changestatus('.$asset_val->id.', \''.$status.'\', \''.$urls.'\' , \''.$table.'\', \''.$field.'\', \''.$field_name.'\');" title="Active">Deactive</a>';
                                    echo $actionStatus;
                                 }else{
                                    $status = 'Deactive';
                                    $actionStatus ='<a class="btn btn-primary waves-effect" style="width: 100% !important;" href="javascript:void(0);" onclick="changestatus('.$asset_val->id.', \''.$status.'\', \''.$urls.'\' , \''.$table.'\', \''.$field.'\', \''.$field_name.'\');" title="Active">Active</a>';
                                    echo $actionStatus;
                                 }
                                 ?>
                              </td>
                              <td>
                                 ...
                                 $edit_slider_url = base_url('employer/asset/assign_list/edit/').encode($asset_val->id);
    ...
    /*"order": [[2,"asc"]],*/
     "columnDefs": [ { "targets": [0,-1], "bSortable": false } ],
      ...
      function view_asset_record(tracking_id){
        ...
        xmlhttp.open("GET","<?php echo base_url('employer/asset/assign_list/get-view-data');?>/"+tracking_id,true);
        xmlhttp.send();
    }
