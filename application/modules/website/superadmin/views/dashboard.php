      ...
      <div class="container-fluid">
         ...
         <div class="row clearfix">
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box green"><?php echo(!empty($total_emp) ? $total_emp : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/users')?>" class="my_sort_cut text-muted">
            ...
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box orange"><?php echo(!empty($tot_member_plans) ? $tot_member_plans : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/plan/list')?>" class="my_sort_cut text-muted">
                     <i class="icon-like"></i>
            ...
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box orange"><?php echo(!empty($tot_trans_history) ? $tot_trans_history : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/transaction')?>" class="my_sort_cut text-muted">
            ...
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box orange"><?php echo(!empty($tot_media_partner) ? $tot_media_partner : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/media-parners/list')?>" class="my_sort_cut text-muted">
            ...
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box orange"><?php echo(!empty($tot_blog) ? $tot_blog : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/blog/list')?>" class="my_sort_cut text-muted">
            ...
            <div class="col-6 col-md-4 col-xl-2">
               <div class="card">
                  <div class="card-body ribbon">
                     <div class="ribbon-box orange"><?php echo(!empty($tot_testimonial) ? $tot_testimonial : '0'); ?></div>
                     <a href="<?php echo base_url('superadmin/testimonial/list')?>" class="my_sort_cut text-muted">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <ul class="list-unstyled team-info sm margin-0 w150">
                                       <li><img src="<?php echo base_url('template/'); ?>superadmin/assets/images/xs/avatar1.jpg" alt="Avatar"></li>
                                       <li><img src="<?php echo base_url('template/'); ?>superadmin/assets/images/xs/avatar2.jpg" alt="Avatar"></li>
                                       <li><img src="<?php echo base_url('template/'); ?>superadmin/assets/images/xs/avatar3.jpg" alt="Avatar"></li>
                                       <li><img src="<?php echo base_url('template/'); ?>superadmin/assets/images/xs/avatar4.jpg" alt="Avatar"></li>
