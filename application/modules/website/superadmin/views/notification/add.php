   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
           <a href="<?php echo base_url(ADMIN_URL).'notification'; ?>" class="btn btn-primary"></i>Back</a>
         </div>
      </div>
   </div>
</div>
      ...
      <div class="tab-content mt-3">
         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                  <form method="post" action="<?php echo base_url('superadmin/notification/addNotification'); ?>" data-parsley-validate="" enctype="multipart/form-data">
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="form-group">
                              <label>Subject</label>
                              <input type="text" name="subject" class="form-control" placeholder="Subject name" required="" data-parsley-required-message="Please enter subject name">
                          </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          <div class="form-group">
