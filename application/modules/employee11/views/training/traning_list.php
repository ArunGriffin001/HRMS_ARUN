                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-vcenter text-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="width45">Node Training</td>
                                        <td>
                                        ...
                                        <td>
                                            <img src="<?php echo base_url('template/'); ?>employee/assets/images/avatar2.jpg" data-toggle="tooltip" data-placement="top" alt="Avatar" class="avatar" data-original-title="Avatar Name" />
                                            <img src="<?php echo base_url('template/'); ?>employee/assets/images/avatar1.jpg" data-toggle="tooltip" data-placement="top" alt="Avatar" class="avatar" data-original-title="Avatar Name" />
                                            <img src="<?php echo base_url('template/'); ?>employee/assets/images/avatar2.jpg" data-toggle="tooltip" data-placement="top" alt="Avatar" class="avatar" data-original-title="Avatar Name" />
                                        </td>
                                        <td>24 Jun, 2015</td>
