         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                 ...
                 <form method="post" enctype="multipart/form-data" action="<?php echo base_url('superadmin/media-parners/update/'.encode($record->id)); ?>" data-parsley-validate=""  >
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>Title </label>
                              <input type="hidden" name="id" class="form-control" value="<?php echo $record->id?>">
                              <input type="text" name="title" class="form-control" placeholder="Title" required="" value="<?php echo $record->title?>">
                           </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>link</label>
                              <input type="text" name="link" class="form-control" placeholder="link" value="<?php echo $record->link?>">
                           </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>images</label>
                              <input type="file" name="images" class="form-control" placeholder="Select Image" >
                              <img width="100" src="<?php echo base_url("uploads/images/media_parners/".$record->images)?>">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
