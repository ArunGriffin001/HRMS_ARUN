            ...
            <div class="card">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                      <table id="enquiry_list" class="table table-striped table-hover table-vcenter text-nowrap mb-0">
                        <thead>
                          <tr>
...
<script type="text/javascript">
  ...
  var postListingUrl =  BASEURL+"enquiry_list";
...
function view_transaction_history(field_id)
    {
     // alert(field_id)
        ...
        xmlhttp.open("GET","<?php echo base_url(ADMIN_URL);?>enquiry/get-view-enquiry-data/"+field_id,true);
        xmlhttp.send();
    }
</script>
