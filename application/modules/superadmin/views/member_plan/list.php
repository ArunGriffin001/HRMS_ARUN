   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
            <a href="<?php echo base_url('superadmin/plan/add'); ?>" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Add Plan</a>
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                      <table id="planList" class="table table-striped table-hover table-vcenter text-nowrap mb-0">
                        <thead>
                          <tr>
...
<script type="text/javascript">
  ...
  var postListingUrl =  BASEURL+"plan_list";
  $('#planList').dataTable({
    "bPaginate": true,
    "pageLength": 50,
    "bLengthChange": true,
