   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
           <a href="<?php echo base_url(ADMIN_URL).'blog-cat/list'; ?>" class="btn btn-primary"></i>Back</a>
         </div>
      </div>
   </div>
</div>
         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                  ...
                  <form method="post" action="<?php echo base_url('superadmin/submit_cat'); ?>" data-parsley-validate="">
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>Name</label>
                              <input type="text" name="title" class="form-control" placeholder="Category name" data-parsley-required-message="Please add category name" required="" data-parsley-required-message="Please add category name">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
