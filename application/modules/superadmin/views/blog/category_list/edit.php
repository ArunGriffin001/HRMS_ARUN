         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                  ...
                  <form method="post" action="<?php echo base_url(ADMIN_URL).'blog-cat/updateCat/'.encode($record->id); ?>" data-parsley-validate="">
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>Name</label>
                              <input type="text" name="title" class="form-control" value="<?php echo $record->title; ?>" placeholder="Category name" required="">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
