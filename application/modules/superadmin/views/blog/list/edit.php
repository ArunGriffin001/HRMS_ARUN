                          ...
                          <?php
                            if(!empty($blog_rss_arr)){
                              foreach ($blog_rss_arr as $key => $blog_rss) {
                                //$res = '';
                                $res2 = array_search($blog_rss->rss_id, array_column($blog_rss_option, 'blog_rss_id'));
                                 //var_dump($res);
                              ?>
                              <input type="checkbox" name="rss_id[]" class="" value="<?php echo $blog_tag->id; ?>" data-parsley-mincheck="1" <?php echo($res2 === false ? '' : 'checked'); ?> required> <?php echo ' '.$blog_rss->rss_title; ?>
                              <?php
                              }
                            }
                            ?>
