   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
            <a href="<?php echo base_url('superadmin/blog/add'); ?>" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Add Blog</a>
            ...
            <div class="card">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                      <table id="blogList" class="table table-striped table-hover table-vcenter text-nowrap mb-0">
                        <thead>
                          <tr>
...
<script type="text/javascript">
  ...
  var postListingUrl =  BASEURL+"blog_list";
  $('#blogList').dataTable({
    "bPaginate": true,
    "pageLength": 50,
    "bLengthChange": true,
