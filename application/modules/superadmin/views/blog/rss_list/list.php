   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
            <a href="<?php echo base_url('superadmin/blogs/blog-rss/add'); ?>" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Add RSS</a>
...
<script type="text/javascript">
  ...
  var postListingUrl =  BASEURL+"blogs/rss_list";
