   ...
   <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center">
         ...
         <div class="header-action text-right mt-2">
            <a href="<?php echo base_url(ADMIN_URL).'blogs/blog-rss/list'; ?>" class="btn btn-primary"></i>Back</a>
         </div>
      </div>
   </div>
</div>
         ...
         <div class="" id="user-add" role="tabpanel">
            <div class="card">
               ...
               ?>
                  ...
                  <form method="post" action="<?php echo base_url('superadmin/blogs/submmit_rss'); ?>" data-parsley-validate="">
                     <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
                              <label>Name</label>
                              <input type="text" name="rss_title" class="form-control" placeholder="RSS name" data-parsley-required-message="Please add rss name" required="">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                           <div class="form-group">
