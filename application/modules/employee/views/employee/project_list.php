                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7 py-1">
                                        <div class="avatar-list avatar-list-stacked">
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar1.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar2.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar3.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar4.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar5.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-7 py-1">
                                        <div class="avatar-list avatar-list-stacked">
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar6.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar7.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar8.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar1.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <img class="avatar avatar-sm" src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar2.jpg" data-toggle="tooltip" title="" data-original-title="Avatar Name" />
                                            <span class="avatar avatar-sm">+8</span>
                                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-vcenter mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar1.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Isidore Dilao</span></td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar2.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Maricel Villalon</span></td>
                                        <td>Account receivable</td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar3.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Theresa Wright</span></td>
                                        <td>Approval site</td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar4.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Jason Porter</span></td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar5.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Annelyn Mercado</span></td>
                                        <td>Account receivable</td>
                                        <td><span>30:00</span></td>
                                        <td>30:0 hrs</td>
                                        <td><span>None</span></td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar6.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Sean Black</span></td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar7.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>Scott Ortega</span></td>
                                        <td>Account receivable</td>
                                    ...
                                    <tr>
                                        <td><img src="<?php echo base_url('template/'); ?>employee/assets/images/xs/avatar8.jpg" alt="Avatar" class="w30 rounded-circle mr-2" /> <span>David Wallace</span></td>
                                        <td>Account receivable</td>
                                        <td><span>30:00</span></td>
                                        <td>30:0 hrs</td>
                                        <td><span>None</span></td>
