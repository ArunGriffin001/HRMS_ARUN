<div class="header_btn">
   <div class="header-action">
      <a href="<?php echo base_url('employee/employee/compliance'); ?>" class="btn btn-primary float-right"><i class="fa fa-plus mr-2"></i>Back</a>
   </div>
</div>
                                          ...
                                          <table class="table">
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><span class="text-left"><?php echo(!empty($cal_list['joining_date']) ? date('Y-m-d',strtotime($cal_list['emp_name'])) : 'NA'); ?></span></td>
                                                </tr>
                                                <tr>
                                          ...
                                          <table class="table">
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><span class="text-left"><?php echo(!empty($cal_list['current_month_LWP']) ? $cal_list['current_month_LWP'] : 'NA'); ?></span></td>
                                                </tr>
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <table class="table">
                                             <tbody>
                                                   ...
                                                   <td>
                                                      <span class="text-left">
                                                         ...
                                                         echo (!empty($cal_list['professional_tax']) ? round($cal_list['professional_tax']) : 'NA');
                                                          $professional_tax = (!empty($cal_list['professional_tax']) ? round($cal_list['professional_tax']) : 0);
                                                ...
                                                <tr>
                                                   <td><span class="text-left">Employer EPF Contribution </strong></td>
                                                   <td>
                                                      <span class="text-left">
                                                         <?php 
                                                         echo (!empty($cal_list['employer_share']) ? round($cal_list['employer_share']) : 'NA'); 
                                                         $employer_share = (!empty($cal_list['employer_share']) ? round($cal_list['employer_share']) : 0);
                                                         ?>
                                                         </span>
                                                      </td>
                                                </tr>
                                                ...
                                                <tr>
                                                   <td><span class="text-left">Employee EPF Contribution </strong></td>
                                                   <td>
                                                      <span class="text-left">
                                                         <?php 
                                                         echo (!empty($cal_list['employee_share']) ? round($cal_list['employee_share']) : 'NA'); 
                                                         $employee_share = (!empty($cal_list['employee_share']) ? round($cal_list['employee_share']) : 0);
                                                         ?>
                                                         </span>
                                                      </td>
                                                </tr>
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span class="text-left">
                                                         <?php 
                                                         echo (!empty($cal_list['employer_pen_contribution']) ? round($cal_list['employer_pen_contribution']) : 'NA'); 
                                                         $employer_pen_contribution = (!empty($cal_list['employer_pen_contribution']) ? round($cal_list['employer_pen_contribution']) : 0);
                                                         ?>
                                                         </span>
                                                      </td>
                                                </tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span class="text-left">
                                                         <?php 
                                                         echo (!empty($cal_list['admin_pf_charges']) ? round($cal_list['admin_pf_charges']) :'NA');
                                                         $admin_pf_charges = (!empty($cal_list['admin_pf_charges']) ? round($cal_list['admin_pf_charges']) : 0); 
                                                         ?>
                                                         </span>
                                                      </td>
                                                </tr>
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span class="text-left">
                                                         <?php 
                                                         echo (!empty($cal_list['admin_EDLI_charges']) ? round($cal_list['admin_EDLI_charges']) : 'NA'); 
                                                         $admin_EDLI_charges = (!empty($cal_list['admin_EDLI_charges']) ? round($cal_list['admin_EDLI_charges']) : 0);
                                                         ?>
                                                         </span>
                                                      </td>
                                                </tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span class="text-left"><?php echo(!empty($cal_list['personal_loan_principal']) ? round($cal_list['personal_loan_principal']) : 'NA'); 
                                                         $personal_loan_principal = (!empty($cal_list['personal_loan_principal']) ? round($cal_list['personal_loan_principal']) : 0);
                                                         ?>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <span class="text-left">
                                                         <?php echo(!empty($cal_list['personal_loan_Interest']) ? round($cal_list['personal_loan_Interest']) : 'NA');
                                                         $personal_loan_Interest = (!empty($cal_list['personal_loan_Interest']) ? round($cal_list['personal_loan_Interest']) : 0);
                                                         ?>
                                       ...
                                       <div class="col-md-6 border-right">
                                          <table class="table">
                                             <tbody>
                                                <tr>
                                                   <td><strong class="text-left">Total Earnings</strong></td>
                                                   <td><span class="text-left"><strong> <?php echo $earning; ?></strong></span></td>
                                                </tr>
                                             </tbody>
                                          </table>
                                       </div>
                                          ...
                                          <table class="table">
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td><span class="text-left"><strong><?php 
                                          $deduction =  $employer_share + $employee_share + $employer_pen_contribution + $professional_tax + $admin_pf_charges + $admin_EDLI_charges+ $personal_loan_principal+ $personal_loan_Interest;
