                            ...
                            <a href="javascript:void(0)" class="dash-card text-dark">
                                <div class="dash-card-container">
                                    ...
                                    <div class="dash-card-content">
                                        <?php 
                                            $dateofbirth = ( !empty($user_info->dob) ? date('D, jS \\o\\f M', strtotime($user_info->dob)) : 'Date of borth is not available');
                                            
                                        ?>
                                        <h6 class="mb-0"><?php echo $dateofbirth; ?></h6>
                                    </div>
                                    <div class="dash-card-avatars">
                                        <div class="e-avatar"><img class="img-fluid" src="<?php echo base_url('template/'); ?>employee/assets/images/user.png" alt="Avatar" /></div>
                                    </div>
                                </div>
                            </a>
                            <hr />
                            <h4 class="pt-20">Anniversary</h4>
                            <a href="javascript:void(0)" class="dash-card text-dark">
                                <div class="dash-card-container">
                                    <div class="dash-card-icon text-warning">
                                        <i class="fa fa-birthday-cake" aria-hidden="true"></i>
                ...
                <div class="card">
                   ...
                   //$this->session->unset_userdata('punching_data');
                    if(!empty($punch_today) && $punch_today->punch_status == '2'){
                        ...
                        <div class="punch-btn-section">
                            <button type="button" class="btn btn-primary punch-btn" >Break In</button>
                        </div>
                        <div class="punch-btn-section">
                        ...
                        ?>
                           ...
                           <!--  <div class="punch-btn-section punchout_button punch">
                                <button type="button" class="btn btn-primary punch-btn punch_in " status="1">Punch Out</button>
                            </div> -->
                        <?php
                        }else{
                            ?>
