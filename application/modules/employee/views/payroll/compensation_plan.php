            ...
            <div class="tab-pane fade show active" id="Accounts-Invoices" role="tabpanel">
                ...
                <div class="card">
                    <div class="card-header">
                        <!-- <h3 class="card-title">
                            <span> <i class="fa fa-square-o" aria-hidden="true"></i> New employee joinee</span> <span class="pl-20"> <i class="fa fa-square-o" aria-hidden="true"></i> Exit Employee</span>
                        </h3> -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        <th>Upcoming Month</th>
                                        <th>Estimated Employee Count</th>
                                        <th>Compenstation Cost</th>
                                        <th>Fix Pay</th>
                                        <th>Bonus</th>
                                        <th>Others</th>
                                    </tr>
