    ...
    <div class="main-header-area main-header-02 main-header-06 header-06-bg pt-20 pb-10">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                    ...
                    <div class="main-menu main-menu-02 main-menu-06 d-none d-lg-block text-lg-end ml-45">
                        <nav>
                            <ul>
                                ...
                                <li class="mr-10 d-lg-inline-block">
                                    <a href="<?php echo base_url('sign-in'); ?>" class="theme_btn theme_btn_bg theme-border-btn border-02">Log In <i class="fas fa-chevron-right"></i></a>
                                </li>
                ...
                <div class="col-xxl-3 col-xl-2 col-lg-3 col-md-6 col-6 text-end d-md-block d-lg-none">
        ...
        <ul id="mobile-menu-active">
            ...
            <li class="has-dropdown">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="<?php echo base_url('learning-management'); ?>">Learning & development Management</a></li>
            ...
            <li class="padding_bottom">
              <a href="<?php echo base_url('sign-in'); ?>" class="theme_btn theme-border-btn border-02 mobile_btn">Log In <i class="fas fa-chevron-right"></i></a>
            </li>
            <li>
            <a href="<?php echo base_url('signup'); ?>" class="theme_btn mobile_btn">Sign Up<i class="fas fa-chevron-right"></i></a>
            </li>
        </ul>
    </nav>
